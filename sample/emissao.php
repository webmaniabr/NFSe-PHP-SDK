...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($json->servico)) {
        ...
        <div id="container_box">
            <div id="container_left">
                ...
                <div id="list_box">
                    ...
                    <div class="list_option list_option_selected" onclick="window.location.reload()">EMISSÃO</div>
                            ...
                            <script>
                                ...
                                function executa() 
                                {
                                    ...
                                    fetch(window.location.href, {
                                        ...
                                        body: JSON.stringify({ "servico": servicos,
                                                               "impostos": impostos,
                                                               "tomador": tomador })
                                    }).then((retorno) => {
                                        return retorno.text();
