...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($json->uuid) && isset($json->motivo)) {
    include_once('./autoload.php');
    Connection::getInstance()->setBearerToken($_GET['bearer']);
    $nfse = new NFSe();
    $nfse->uuid = $json->uuid;
    try {
        $response = $nfse->cancelar($json->motivo);
        ...
        <div id="container_box">
            <div id="container_left">
                ...
                <div id="list_box">
                    ...
                    <div class="list_option" onclick="window.location.href = `/substituicao.php${window.location.search}`">SUBSTITUIÇÃO</div>
                    <div class="list_option list_option_selected" onclick="window.location.reload()">CANCELAMENTO</div>
                </div>
            </div>
